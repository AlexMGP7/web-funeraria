...
class EstadoController
{
    ...
    static public function BuscarUltimaestado()
    {
        require_once('models/estado_model.php');
    ...
    {
        require_once('models/estado_model.php');
        $result_Listar = estado_model::BuscarEstadoByCodigo($codigo);
        return $result_Listar;
    }
    ...
    static public function UpdateEstado2($codigo, $descripcion)
    {
        require_once('models/estado_model.php');
